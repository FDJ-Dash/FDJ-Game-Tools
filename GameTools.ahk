...
;------------- App Details ------------
; App Name: Game Tools.
; Short Descryption: Repetitive task automation Modules.
;----------------------------------------------------
...
;----------------------------------------------------
; Copyright (C) 2024 Fernando Daniel Jaime
...
, IniFile := A_ScriptDir . "\GameTools.ini"
	...
	if SwitchClicker == true {
		...
		if ClearXY == true {
			...
			if ResizeModule == true {
			    ...
			    Position23.EditPosX.Value := ""
			    Position23.EditPosY.Value := ""
				
				Position24.EditPosX.Value := ""
			    Position24.EditPosY.Value := ""
				
				Position25.EditPosX.Value := ""
			    Position25.EditPosY.Value := ""
				
				Position26.EditPosX.Value := ""
			    Position26.EditPosY.Value := ""
				
				Position27.EditPosX.Value := ""
			    Position27.EditPosY.Value := ""
				
				Position28.EditPosX.Value := ""
			    Position28.EditPosY.Value := ""
				
				Position29.EditPosX.Value := ""
			    Position29.EditPosY.Value := ""
				
				Position30.EditPosX.Value := ""
			    Position30.EditPosY.Value := ""
			}
		}
		...
		if ResizeModule == true {
			...
			if Position23.EditPosX.Value == "" or Position23.EditPosY.Value == "" {
			    Position23.EditRadioYes.Value := false
			    Position23.EditRadioNo.Value := true
		    }
			if Position24.EditPosX.Value == "" or Position24.EditPosY.Value == "" {
			    Position24.EditRadioYes.Value := false
			    Position24.EditRadioNo.Value := true
		    }
			if Position25.EditPosX.Value == "" or Position25.EditPosY.Value == "" {
			    Position25.EditRadioYes.Value := false
			    Position25.EditRadioNo.Value := true
		    }
			if Position26.EditPosX.Value == "" or Position26.EditPosY.Value == "" {
			    Position26.EditRadioYes.Value := false
			    Position26.EditRadioNo.Value := true
		    }
			if Position27.EditPosX.Value == "" or Position27.EditPosY.Value == "" {
			    Position27.EditRadioYes.Value := false
			    Position27.EditRadioNo.Value := true
		    }
			if Position28.EditPosX.Value == "" or Position28.EditPosY.Value == "" {
			    Position28.EditRadioYes.Value := false
			    Position28.EditRadioNo.Value := true
		    }
			if Position29.EditPosX.Value == "" or Position29.EditPosY.Value == "" {
			    Position29.EditRadioYes.Value := false
			    Position29.EditRadioNo.Value := true
		    }
			if Position30.EditPosX.Value == "" or Position30.EditPosY.Value == "" {
			    Position30.EditRadioYes.Value := false
			    Position30.EditRadioNo.Value := true
		    }
		}
		...
		if GetKeyState("RButton", "P"){
			...
			if ResizeModule == true {
			    ...
			    case Position22.EditPosX.Value == "" or Position22.EditPosY.Value == "":
				    ...
				    sleep 500
				case Position23.EditPosX.Value == "" or Position23.EditPosY.Value == "":
				    Position23.EditPosX.Value := x
				    Position23.EditPosY.Value := y
				    Position23.EditRadioYes.Value := true
				    Position23.EditRadioNo.Value := false
				    sleep 500
				case Position24.EditPosX.Value == "" or Position24.EditPosY.Value == "":
				    Position24.EditPosX.Value := x
				    Position24.EditPosY.Value := y
				    Position24.EditRadioYes.Value := true
				    Position24.EditRadioNo.Value := false
				    sleep 500
				case Position25.EditPosX.Value == "" or Position25.EditPosY.Value == "":
				    Position25.EditPosX.Value := x
				    Position25.EditPosY.Value := y
				    Position25.EditRadioYes.Value := true
				    Position25.EditRadioNo.Value := false
				    sleep 500
				case Position26.EditPosX.Value == "" or Position26.EditPosY.Value == "":
				    Position26.EditPosX.Value := x
				    Position26.EditPosY.Value := y
				    Position26.EditRadioYes.Value := true
				    Position26.EditRadioNo.Value := false
				    sleep 500
				case Position27.EditPosX.Value == "" or Position27.EditPosY.Value == "":
				    Position27.EditPosX.Value := x
				    Position27.EditPosY.Value := y
				    Position27.EditRadioYes.Value := true
				    Position27.EditRadioNo.Value := false
				    sleep 500
				case Position28.EditPosX.Value == "" or Position28.EditPosY.Value == "":
				    Position28.EditPosX.Value := x
				    Position28.EditPosY.Value := y
				    Position28.EditRadioYes.Value := true
				    Position28.EditRadioNo.Value := false
				    sleep 500
				case Position29.EditPosX.Value == "" or Position29.EditPosY.Value == "":
				    Position29.EditPosX.Value := x
				    Position29.EditPosY.Value := y
				    Position29.EditRadioYes.Value := true
				    Position29.EditRadioNo.Value := false
				    sleep 500
				case Position30.EditPosX.Value == "" or Position30.EditPosY.Value == "":
				    Position30.EditPosX.Value := x
				    Position30.EditPosY.Value := y
				    Position30.EditRadioYes.Value := true
				    Position30.EditRadioNo.Value := false
				    sleep 500
				}
			} else {
				Switch true {
